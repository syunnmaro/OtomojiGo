...
type Int = number
type Float = number
type Cursor = any // Cursorの型を適切に定義してください
type Time = string // Timeの型を適切に定義してください
...
export type GetWorkNameQuery = {
    __typename?: 'Query'
    getWorkById: { __typename?: 'Work'; id: ID; name: String }
}
...
export type CreateUserMutation = {
    __typename?: 'Mutation'
    createUser: { __typename?: 'User'; id: ID; googleID: String }
}
...
export function getSdk(
    ...
    return {
        ...
        getParts(
            variables: GetPartsQueryVariables,
            requestHeaders?: Dom.RequestInit['headers']
        ): Promise<GetPartsQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<GetPartsQuery>(GetPartsDocument, variables, {
                        ...requestHeaders,
                        ...wrappedRequestHeaders,
                    }),
                'getParts',
        ...
        getWorkName(
            variables: GetWorkNameQueryVariables,
            requestHeaders?: Dom.RequestInit['headers']
        ): Promise<GetWorkNameQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<GetWorkNameQuery>(
                        GetWorkNameDocument,
                        variables,
        ...
        getBlocks(
            ...
            requestHeaders?: Dom.RequestInit['headers']
        ): Promise<GetBlocksQuery> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<GetBlocksQuery>(
                        GetBlocksDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
        ...
        createBlock(
            ...
            requestHeaders?: Dom.RequestInit['headers']
        ): Promise<CreateBlockMutation> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<CreateBlockMutation>(
                        CreateBlockDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
        ...
        createPart(
            variables: CreatePartMutationVariables,
            requestHeaders?: Dom.RequestInit['headers']
        ): Promise<CreatePartMutation> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<CreatePartMutation>(
                        CreatePartDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
        ...
        updatePart(
            variables: UpdatePartMutationVariables,
            requestHeaders?: Dom.RequestInit['headers']
        ): Promise<UpdatePartMutation> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<UpdatePartMutation>(
                        UpdatePartDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
        ...
        updateBlock(
            ...
            requestHeaders?: Dom.RequestInit['headers']
        ): Promise<UpdateBlockMutation> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<UpdateBlockMutation>(
                        UpdateBlockDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
        ...
        deleteWork(
            ...
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<DeleteWorkMutation>(
                        DeleteWorkDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
        ...
        deletePart(
            variables: DeletePartMutationVariables,
            requestHeaders?: Dom.RequestInit['headers']
        ): Promise<DeletePartMutation> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<DeletePartMutation>(
                        DeletePartDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
        ...
        deleteBlock(
            ...
            requestHeaders?: Dom.RequestInit['headers']
        ): Promise<DeleteBlockMutation> {
            return withWrapper(
                (wrappedRequestHeaders) =>
                    client.request<DeleteBlockMutation>(
                        DeleteBlockDocument,
                        variables,
                        { ...requestHeaders, ...wrappedRequestHeaders }
                    ),
