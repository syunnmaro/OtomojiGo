...
export function PartAndWorkDropdown({
    ...
    return (
        <DropdownMenu.Root>
            ...
            <DropdownMenu.Content className="z-40 w-40 rounded-xl bg-white text-xl ">
                <DropdownMenu.Item
            ...
            cache.updateQuery<GetBlocksQuery, GetBlocksQueryVariables>(
                ...
                (result) => {
                    ...
                    return {
                        getPartById: {
                            id: partId,
                            blocks: result.getPartById.blocks?.filter((b) =>
        ...
        <DropdownMenu.Root>
            ...
            <DropdownMenu.Content className="z-10 w-40 rounded-xl bg-white text-xl ">
                ...
                <DropdownMenu.Sub>
                    ...
                    <DropdownMenu.Portal>
                        <DropdownMenu.SubContent
                            className="data-[side=top]:animate-slideDownAndFade data-[side=right]:animate-slideLeftAndFade min-w-[220px] rounded-md bg-white p-[5px] shadow-[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),_0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)] will-change-[opacity,transform]"
                            sideOffset={2}
                            alignOffset={-5}
                        >
    ...
    return (
        <Dialog.Root>
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className="data-[state=open]:animate-contentShow fixed left-[50%] top-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px]  focus:outline-none">
