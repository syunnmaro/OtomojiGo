...
type ComplexityRoot struct {
	...
	Query struct {
		...
		GetUserFromUserID func(childComplexity int) int
...
type QueryResolver interface {
	...
	GetUserFromUserID(ctx context.Context) (*ent.User, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.getUserFromUserId":
		if e.complexity.Query.GetUserFromUserID == nil {
			break
		}

		return e.complexity.Query.GetUserFromUserID(childComplexity), true
...
func (ec *executionContext) _Query_getUserFromUserId(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_getUserFromUserId(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetUserFromUserID(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Query_getUserFromUserId(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) unmarshalInputCreateUserInput(ctx context.Context, obj interface{}) (ent.CreateUserInput, error) {
	...
	fieldsInOrder := [...]string{"stripeID", "point", "workIDs"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUpdateUserInput(ctx context.Context, obj interface{}) (ent.UpdateUserInput, error) {
	...
	fieldsInOrder := [...]string{"stripeID", "point", "addWorkIDs", "removeWorkIDs", "clearWorks"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) unmarshalInputUserWhereInput(ctx context.Context, obj interface{}) (ent.UserWhereInput, error) {
	...
	fieldsInOrder := [...]string{"not", "and", "or", "id", "idNEQ", "idIn", "idNotIn", "idGT", "idGTE", "idLT", "idLTE", "idEqualFold", "idContainsFold", "stripeID", "stripeIDNEQ", "stripeIDIn", "stripeIDNotIn", "stripeIDGT", "stripeIDGTE", "stripeIDLT", "stripeIDLTE", "stripeIDContains", "stripeIDHasPrefix", "stripeIDHasSuffix", "stripeIDEqualFold", "stripeIDContainsFold", "point", "pointNEQ", "pointIn", "pointNotIn", "pointGT", "pointGTE", "pointLT", "pointLTE", "hasWorks", "hasWorksWith"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
	...
	for i, field := range fields {
		...
		case "getUserFromUserId":
			...
			innerFunc := func(ctx context.Context, fs *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_getUserFromUserId(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&fs.Invalids, 1)
				}
				return res
